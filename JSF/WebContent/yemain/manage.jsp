...
<div class="container">
        ...
        <div id="tab-container">
            <ul id='tab' class="list">
                <div class="title">
                    <a href="#"><span class="glyphicon glyphicon-star" aria-hidden="true"></span>管理员信息管理</a>
                </div>
                 <li class="hidden2">
                    <a href="#">查看会员信息</a>
                </li>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <c:forEach   items="${kechengList}"  var="kecheng">
												<tr>
													...
													<td><a href="<%=basePath%>/kecheng/delete.do?Kid=${kecheng.getKid()}">删除
													<a href="<%=basePath%>/kecheng/toEdit.do?Kid=${kecheng.getKid()}">修改</td>
												</tr>
											</c:forEach>
                                        </table>
                                    </form>
                    ...
                    <table class="table table-hover table1">
                        ...
                        <c:forEach   items="${kechengList}"  var="jiaolian">
												<tr>
													...
													<td><a type="button" class="btn btn-default btn-sm"  href="<%=basePath%>/jiaolian/delete.do?Jid=${jiaolian.getJid()}">删除</a></td>
												</tr>
							</c:forEach>
                    </table>
                </div>
                    ...
                    <div class="title1">添加教练信息</div>
                     <form action="<%=basePath%>jiaolian/add.do" class="form-horizontal kecheng"  method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="checkbox">
                                    <input type="radio" value="男"  name="Jsex"> 男
